...
public class MealTestData {
    ...
    public static final String ISO_LOCAL_START_DATE_TIME = of(2015, Month.MAY, 30, 12, 0).format(ISO_LOCAL_DATE_TIME);
    public static final String ISO_LOCAL_END_DATE_TIME = of(2015, Month.MAY, 30, 22, 0).format(ISO_LOCAL_DATE_TIME);
